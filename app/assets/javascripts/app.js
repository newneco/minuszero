...
var x = setInterval(function() {
  ...
  $("#gallery").unitegallery({
          ...
          tiles_space_between_cols: 8,      //space between images
          ...
          tile_border_color:"",    //tile border color
          tile_border_radius:0,       //tile border radius (applied to border only, not to outline)
          
          tile_enable_outline: false,     //enable outline of the tile (works only together with the border)
          tile_outline_color: "",    //tile outline color
          ...
          tile_shadow_color:"",    //shadow color
          ...
          tile_overlay_color: "",    //tile overlay color
          ...
          tile_textpanel_bg_color:"",    //textpanel background color
          ...
          lightbox_numbers_padding_right:null,      //the right padding of the numbers (used in compact mode)
            ...
            lightbox_slider_image_border_color: "",  //image border color
